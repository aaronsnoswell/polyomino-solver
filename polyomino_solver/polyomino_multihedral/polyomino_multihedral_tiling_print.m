...
%  Parameters:
%
%    Input, integer R_SHAPE(R_M,R_N), a matrix of 0's and 1's representing the 
%    region.
%
...
%
%    Input, integer X(X_M), a solution to the problem, consisting 
%    of a binary value (0 or 1) for every possible placement of a polyomino 
%    variant onto R.
%
%    Input, string LABEL, a label for the printout, such as 
%    'Solution #3 of the 2x4 Example'.
%
%    Output, integer R_LABEL(R_M,R_N), an array of indices that suggest
...
%
%    Output, integer R_COLOR(R_M,R_N), an array of indices that indicate
