...
%  Parameters:
%
%    Input, integer R(MR,NR), a binary matrix describing the region.
%
%    Input, integer P(MR,NR,P_NUM), a binary matrix describing the polyominoes.
...
%
%    Output, integer A(EQN_NUM,VAR_NUM), the system matrix.
%
%    Output, integer B(EQN_NUM,1), the right hand side.
%
%    Output, integer VAR_P(VAR_NUM,1).  If variable I is a variant of polyomino
%    J, then VAR_P(I) = J.
%
