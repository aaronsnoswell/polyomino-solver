...
%    of the polyomino P.
%
%    Input, integer P_NUM, the number of polyominoes.
%
%    Input, integer P(MP,NP,P_NUM), for each value K, P(:,:,K) is a matrix of 
...
%
%    Input, integer D(P_NUM), the number of copies of each polyomino that
%    may be used.  If D(I) <= 0, no variants of polyomino I will be generated.
%
%    Output, integer V_NUM, the number of variants found.
%
%    Output, integer V(MP,NP,V_NUM), the variants.
%
%    Output, integer V_P(V_NUM); if V(:,:,I) is a variant of the polyomino
